            ...
            children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              hotel.rate.toString(),
                              style: TextStyle(
                                  fontSize: 16.h, color: Colors.grey),
                            ),
                          ],
                        ),
                      ],
              ...
              Center(child: Padding(
                ...
                child: RoundedButton(
                    text: "BOOKING",
                    press: () async {
                      await hotelController.getDetail(hotel.id);
                      if (hotelController.hotel.value?.available == 0) {
                        Get.to(() => Booking(hotelId: hotelId, userId: userId));
                      } else {
